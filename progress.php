...
<div class="w3-main" style="margin:px">
  ...
  <header class="w3-container w3-xlarge">
    ...
    <p class="w3-right">
      ...
      <a href="about.com"><i class="fa fa-shopping-cart w3-margin-right"></i></a>
	   <a href=""> <i class="fa fa-heart w3-margin-right" ></i></a>
	   
	  
      <a href="login.php" ><i class=" fa fa-sign-in"></i></a>
	   <a href="signup.html"><i class="fa fa-user"></i></a>
	   <a href="signout.php"><i class="fa fa-sign-out"></i></a>
