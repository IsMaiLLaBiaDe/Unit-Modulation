...
">  
  <div>
    <p class="w3-left"><p>Unit-modulation</p></p>
   </div>
 <div>
 <form class="w3-center" action="/action_page.php" novalidate>
  <label class="border-radius: 20px;" for="search"></label>
  <input class="border-radius: 20px;"  type="search" id="search" name="search" required>
  <input class="border-radius: 20px;" type="submit" value="search">
</form>
</div>
	<div>
    <p class="w3-right">
...
?>
  ...
  <div style="width:95%;" class="w3-row ">
   <?php
...
?>
      ...
      <div  style="width: 32%;"   class="w3-col s4">
        <h4>About</h4>
